...
Normal Graph Visualization with LIMIT 300:


 


Custom Map Design Using TileMill:
...
Output:
			...
			Mapping the coordinates in Google Maps We get the below results: (by walk)


 

Directions – google maps – same source and destination as above:  
...
Mapping the coordinates in Google Maps We get the below results: 
